...
export default function ExtendedVoiceLab({ currentLang, setCurrentLang }) {
  ...
  const content = {
    en: {
      ...
      welcome: "discover the hidden depth of your sound",
      details: [
        { icon: <Clock size={20} />, text: "thursdays 19:00" },
        { icon: <Users size={20} />, text: "exploration group" },
        { icon: <Mic2 size={20} />, text: "experimental vocals" },
      ],
    },
    de: {
      title: "extended voice lab",
      welcome: "entdecke die verborgene tiefe deines klangs",
      details: [
        { icon: <Clock size={20} />, text: "donnerstags 19:00" },
        { icon: <Users size={20} />, text: "experimentierfreudige" },
        { icon: <Mic2 size={20} />, text: "experimenteller gesang" },
      ],
    },
  };

  const hearingImg = getImage("hearing.png");
  const tasteImg = getImage("sing.png");
